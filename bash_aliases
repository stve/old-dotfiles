...
# mysql
alias start_mysql="/usr/local/Cellar/mysql/5.1.44/share/mysql/mysql.server start"
alias stop_mysql="/usr/local/Cellar/mysql/5.1.44/share/mysql/mysql.server stop"
